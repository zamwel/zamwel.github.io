...
function pay (data) {
  ...
  let goos=  setInterval(() => {
      ...
      if (
        ...
        document.getElementById('status').innerHTML =
          `Please your payment amount isn't complete please add the remaining balance it its not up to ${data.data.pricing.local.amount} or wait for the vender to rectify this error`
